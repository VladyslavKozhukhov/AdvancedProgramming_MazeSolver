...
#include <ctime>
#include <iostream>
REGISTER_ALGORITHM(TAlgorithm)



TAlgorithm::Cell::~Cell() {}
...
void TAlgorithm::UpdateMove(Cell* mz){
    switch(_direction){
        case Move::DOWN:
...
void TAlgorithm::updateNewLocation( Cell* mz,int triedDir){
...
void TAlgorithm::Cell::updateCell(){
...
AbstractAlgorithm::Move TAlgorithm::move() {
    Cell mz;
    bool dir = false;
    mz.updateCell();
    mz._location = _currentPos;
...
AbstractAlgorithm::Move TAlgorithm::convertIntToMove(int num) {
    switch(num){
        case 0:
            return Move::DOWN;
        case 1:
...
int TAlgorithm::convertMovToInt(){
    switch (_direction){
        case Move::DOWN:
            return 0;
        case Move::UP:
 ...
 */
bool TAlgorithm::chooseNewDirection() {
...
void TAlgorithm::hitBookmark(int seq) {
