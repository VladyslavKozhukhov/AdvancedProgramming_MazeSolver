...
#include <ctime>
#include <iostream>
REGISTER_ALGORITHM(FirstAlgorithm)



FirstAlgorithm::Cell::~Cell() {}
...
void FirstAlgorithm::UpdateMove(Cell* mz){
    switch(_direction){
        case Move::DOWN:
...
void FirstAlgorithm::updateNewLocation( Cell* mz,int triedDir){
...
void FirstAlgorithm::Cell::updateCell(){
...
void FirstAlgorithm::setBookMark(){
    _bookMarked = true;
 ...
 * @return
 */
AbstractAlgorithm::Move FirstAlgorithm::move() {
    Cell mz;
    bool dir = false;
    mz.updateCell();
    mz._location = _currentPos;
...
AbstractAlgorithm::Move FirstAlgorithm::convertIntToMove(int num) {
    switch(num){
        case 0:
             return Move::DOWN;
        case 1:
...
int FirstAlgorithm::convertMovToInt(){
    switch (_direction){
        case Move::DOWN:
            return 0;
        case Move::UP:
 ...
 * @return
 */
bool FirstAlgorithm::validateDir(){
 ...
 */
bool FirstAlgorithm::chooseNewDirection() {
