...
#include <ctime>
#include <iostream>
REGISTER_ALGORITHM(SecondSmartAlgorithm)
 ...
 * @return
 */
AbstractAlgorithm::Move SecondSmartAlgorithm::move() {
...
AbstractAlgorithm::Move  SecondSmartAlgorithm::convertIntToMove(int num) {
    switch(num){
        case 0:
            return Move::DOWN;
        case 1:
