...
#include <ctime>
#include <iostream>
REGISTER_ALGORITHM(FirstSmartAlgorithm)



FirstSmartAlgorithm::Cell::~Cell() {
...
AbstractAlgorithm::Move FirstSmartAlgorithm::move() {
    Cell mz;
    bool dir = false;
    bool visited = true;
    mz.updateCell();
...
AbstractAlgorithm::Move FirstSmartAlgorithm::convertIntToMove(int num) {
    switch(num){
        case 0:
            return Move::DOWN;
        case 1:
