...
GameManagerTmp::GameManagerTmp(Maze &maze, const string &outputDir,const string &algoName, unique_ptr<AbstractAlgorithm> player) :
        _maze(maze),
...
//pair<int, int> GameManagerTmp::getNewPlayerCordinates(AbstractAlgorithm::Move move) {
...
//}
//
bool GameManagerTmp::validateMove(pair<int, int> locToCheck, AbstractAlgorithm::Move playerMove, stack<char> *movements,
...
//
//int GameManagerTmp::validateHitWithBookMark(pair<int, int> locToCheck) {
//    int index = -1;
//    int counter = 0;
...
void GameManagerTmp::copyPath(stack<char> *movements) {
...
char GameManagerTmp::convertMovToChar(AbstractAlgorithm::Move move) {
    switch (move) {
        case AbstractAlgorithm::Move::DOWN:
            return 'D';
        case AbstractAlgorithm::Move::UP:
